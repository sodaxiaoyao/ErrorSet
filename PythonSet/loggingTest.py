...
def _handler(filter,formatter):
	...
	logging.hanlders.TimedRotatingFileHandler("logs/myapp.log", when='S', interval=1, backupCount=3)  
	
	fh.addFilter(filter)
	fh.removeFilter(filter)
